...
import { Server, Smartphone, ShieldCheck, Cloud } from "lucide-react";
    ...
    <section id="services" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          Delivering end-to-end backend engineering, Progressive Web Apps, and production-grade cloud deployments.
        </p>
      </motion.div>
