...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/muhammad-engr-waqas", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/engr-muhammad-waqas", label: "LinkedIn" },
    { icon: WhatsAppIcon, href: "https://wa.me/923069377493?text=Hello%20Muhammad%20Waqas!%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20connect.", label: "WhatsApp" },
    { icon: Mail, href: "mailto:mwaqasjutt17@gmail.com", label: "Email" },
    { icon: Globe, href: "https://engrmwaqas.online", label: "Portfolio" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 flex flex-col gap-10">
        ...
        <div className="pt-6 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          ...
          <div className="font-medium text-center md:text-right">
            <span>© {new Date().getFullYear()} Muhammad Waqas. All rights reserved.</span>
          </div>
        </div>
