  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      details: [
        "Specialized in Software Architecture, Database Systems, and Web Engineering",
        "Built production-ready backend systems with Node.js, Express, and MongoDB",
        "Rigorous coursework in Data Structures, Algorithms, Distributed Computing, and API Security",
        "Completed capstone engineering projects with end-to-end full-stack architectures"
      ]
    },
    {
      degree: "Intermediate in Computer Science (ICS)",
      school: "Superior College Vehari (BISE Multan)",
      year: "2018 – 2020",
      ...
      icon: BookOpen,
      details: [
        "Strong foundation in Computer Science, Mathematics, and Analytical Problem Solving",
        "Matriculation (Science) completed at Abdul Khaliq School, Vehari (2016 – 2018)",
        "Certified in Microsoft Office and Digital Skills (Digital Literacy)",
        "Active participation in campus programming challenges and tech workshops"
      ]
    }
  ];
