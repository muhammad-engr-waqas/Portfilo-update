...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "Node.js & Express.js", level: 95, icon: Server, color: "text-emerald-400" },
    { name: "Databases (MongoDB, PostgreSQL, MySQL)", level: 92, icon: Database, color: "text-amber-400" },
    { name: "JavaScript (ES6+) & TypeScript", level: 90, icon: Code2, color: "text-blue-400" },
    { name: "RESTful APIs & JWT / RBAC", level: 94, icon: Atom, color: "text-cyan-400" },
    { name: "DevOps & Cloud (Docker, Redis, AWS)", level: 86, icon: Cloud, color: "text-purple-400" },
  ];

  const softSkills = [
    { name: "Team Leadership", icon: Crown, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "MVC Architecture", icon: Workflow, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "API Security & Auth", icon: Brain, color: "text-purple-400 border-purple-500/30 bg-purple-500/10" },
    { name: "Independent Deployment", icon: Rocket, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "Database Optimization", icon: Lightbulb, color: "text-yellow-400 border-yellow-500/30 bg-yellow-500/10" },
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                <strong className="text-foreground font-bold text-sm block mb-0.5">
                  End-to-End Production Architect
                </strong>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Strong focus on API security, database optimization, and clean, maintainable code across production systems.
                </p>
              </div>
            </div>
          </div>
